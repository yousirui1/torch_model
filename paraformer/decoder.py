...
from sanm.positionwise_feed_forward import PositionwiseFeedForwardDecoderSANM
    ...
    def __init__(
        ...
        self.decoders = repeat(
            ...
            lambda lnum: DecoderLayerSANM(
                attention_dim,
                MultiHeadedAttentionSANMDecoder(
                    attention_dim, self_attention_dropout_rate, kernel_size, sanm_shfit=sanm_shift
                ),
                MultiHeadedAttentionCrossAtt(
                    attention_heads,
                    attention_dim,
        ...
        #self.tf2torch_tensor_name_prefix_torch = tf2torch_tensor_name_prefix_tensor
